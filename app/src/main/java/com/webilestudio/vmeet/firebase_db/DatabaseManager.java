package com.webilestudio.vmeet.firebase_db;
    ...
    public void updateFCMToken(String token) {
        try {
            if (sharedObjects.getUserInfo() != null) {
                databaseUsers.child(sharedObjects.getUserInfo().getId()).child("device_id").setValue(token);
                databaseUsers.child(sharedObjects.getUserInfo().getId()).child("device_type").setValue("a");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
