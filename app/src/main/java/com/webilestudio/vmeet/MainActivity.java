...
import com.webilestudio.vmeet.home.HomeFragment;
import com.webilestudio.vmeet.meeting.MeetingActivity;
import com.webilestudio.vmeet.meeting_history.MeetingHistoryFragment;
import com.webilestudio.vmeet.schedule.ScheduleFragment;
import com.webilestudio.vmeet.settings.SettingsFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            if (Intent.ACTION_VIEW.equals(action)) {
                Log.e("Activity", action + " is");
                Uri uri = intent.getData();
                if (uri != null) {
                    String MEETING_ID = uri.toString().substring(uri.toString().lastIndexOf("/") + 1);
                    Log.e("MEETING_ID", uri.toString() + " - " + MEETING_ID);
                    AppConstants.MEETING_ID = MEETING_ID;
...
//                        Log.e("fcmtoken", fcmtoken);
                        databaseManager.updateFCMToken(fcmtoken);
                    }
                });
